...
sigma=median(min(celldist+(eye(3039)*1000)));
...
load pso_gene_weights.mat best_weights_20
...
%%
selected20Genes = find(~removed);
save subchallenge3_results.mat selected20Genes predictions
